...
export function renderDropdownMenu(options) {
  ...
  triggerBtn.className = "btn dropdown__trigger btn--icon";
  
  triggerBtn.setAttribute("aria-label", "Actions menu");
  triggerBtn.setAttribute("data-tooltip", "Actions menu");

  triggerBtn.type = "button";
  triggerBtn.setAttribute("aria-label", "Open menu");  

  triggerBtn.innerHTML = `
    <svg class="icon dropdown__icon-svg" viewBox="0 0 640 640">
